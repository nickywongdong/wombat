...
if("TRUE" STREQUAL "TRUE")
  set(um6_SOURCE_PREFIX /home/nvidia/wombat/source/um6-indigo-devel)
  set(um6_DEVEL_PREFIX /home/nvidia/wombat/source/um6-indigo-devel/devel)
  set(um6_INSTALL_PREFIX "")
  set(um6_PREFIX ${um6_DEVEL_PREFIX})
else()
  set(um6_SOURCE_PREFIX "")
  set(um6_DEVEL_PREFIX "")
  set(um6_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/nvidia/wombat/source/um6-indigo-devel/devel/include;/home/nvidia/wombat/source/um6-indigo-devel/include " STREQUAL " ")
  set(um6_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/wombat/source/um6-indigo-devel/devel/include;/home/nvidia/wombat/source/um6-indigo-devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'um6' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/wombat/source/um6-indigo-devel/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/wombat/source/um6-indigo-devel/devel/lib;/opt/ros/kinetic/lib)
...
set(um6_EXPORTED_TARGETS "um6_generate_messages_cpp;um6_generate_messages_eus;um6_generate_messages_lisp;um6_generate_messages_nodejs;um6_generate_messages_py")
